...
-- CreateEnum
CREATE TYPE "public"."FilterType" AS ENUM ('select', 'multi_select', 'range', 'boolean');

-- CreateEnum
CREATE TYPE "public"."OrderStatus" AS ENUM ('created', 'confirmed', 'completed', 'cancelled');
...
-- AddForeignKey
ALTER TABLE "public"."order" ADD CONSTRAINT "order_manager_id_fkey" FOREIGN KEY ("manager_id") REFERENCES "public"."user"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."order" ADD CONSTRAINT "order_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "public"."user"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."order" ADD CONSTRAINT "order_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."order_log" ADD CONSTRAINT "order_log_order_id_fkey" FOREIGN KEY ("order_id") REFERENCES "public"."order"("id") ON DELETE CASCADE ON UPDATE CASCADE;
