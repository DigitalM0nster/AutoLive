...
type Props = {
	/** Если передан — логи одного заказа, иначе все логи заказов */
	orderId?: number;
};

export default function OrderLogsComponent({ orderId }: Props) {
	...
	const tableHeaders = useMemo(
		() => (
			<tr>
				...
				{!orderId && (
					<th className={styles.tableHeaderCell}>Заказ</th>
				)}
				<th className={styles.tableHeaderCell}>
					<AdminSearchField
