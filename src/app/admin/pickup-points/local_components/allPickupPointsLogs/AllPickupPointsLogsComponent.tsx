...
import AllPickupPointsLogsTable from "./AllPickupPointsLogsTable";
	...
	({ adminSearch, onSearchChange, onClearSearch }: { adminSearch: string; onSearchChange: (v: string) => void; onClearSearch: () => void }) => (
		<div className="searchFilterHeader">
			...
			<div className="searchInput">
				<input type="text" value={adminSearch} onChange={(e) => onSearchChange(e.target.value)} placeholder="ФИО администратора" />
...
export default function AllPickupPointsLogsComponent() {
	...
	const tableHeaders = useMemo(
		() => (
			<tr>
				...
				<th className={styles.tableHeaderCell}>Пункт выдачи</th>
				<th className={styles.tableHeaderCell}>
	...
	return (
		<div className="tableContent">
			...
			<AllPickupPointsLogsTable tableHeaders={tableHeaders} queryParams={queryParams} onLogsUpdate={handleLogsUpdate} adminSearch={adminSearch} />
