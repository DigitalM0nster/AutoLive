			...
			<div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
				{sections.map(({ href, label, desc, icon: Icon, bg }) => (
					<Link
						key={href}
						href={href}
						className="group relative p-6 rounded-2xl border bg-white/80 backdrop-blur shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 hover:bg-white"
					>
